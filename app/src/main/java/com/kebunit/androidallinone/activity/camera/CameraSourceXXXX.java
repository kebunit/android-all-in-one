 ...
 * {@link CameraSourceXXXX.Builder#setRequestedFps(float)} to specify a frame rate that works well with
...
public class CameraSourceXXXX {
    ...
    public static class Builder {
        ...
        private CameraSourceXXXX mCameraSource = new CameraSourceXXXX();
    ...
    public CameraSourceXXXX start() throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
     ...
     */
    @RequiresPermission(Manifest.permission.CAMERA)
    public CameraSourceXXXX start(SurfaceHolder surfaceHolder) throws IOException {
        synchronized (mCameraLock) {
            if (mCamera != null) {
                return this;
            }
